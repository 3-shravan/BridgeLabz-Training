...
class InPatient extends Patient {
  ...
  public void displayInfo() {
    System.out.println("InPatient ID: " + getId() + ", Name: " + getName() + ", Age: " + getAge() +
        ", Doctor: " + getDoctor().getName() + ", Days Admitted: " + daysAdmitted +
...
class OutPatient extends Patient {
  ...
  @Override
  public void displayInfo() {
    System.out.println("OutPatient ID: " + getId() + ", Name: " + getName() + ", Age: " + getAge() +
        ", Doctor: " + getDoctor().getName() + ", Consultation Fee: " + consultationFee);
  }
}
