...
class FlightService {
  ...
  Flight[] flights = { new Flight("AI101", "New York", "London", true), new Flight("BA202", "London", "Paris", false),
      new Flight("DL303", "Paris", "Berlin", true) };

  public void displayAllFlights() {
    for (Flight flight : flights) {
      System.out.println("Flight No: " + flight.getFlightNo() + ", From: " + flight.getFrom() + ", To: "
          + flight.getTo() + ", Available: " + (flight.isAvailable() ? "Yes" : "No"));
    }
  }
